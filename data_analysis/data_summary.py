...
def main(data_dir, output_file):
    ...
    main_data.to_excel(output_file, sheet_name=SHEET_NAME, columns=column_headers, index=False)

if __name__ == "__main__":
    data_dir = sys.argv[1] if len(sys.argv) > 1 else '../data/complete_data/'
    output_file = sys.argv[2] if len(sys.argv) > 2 else 'REACH_summary.xls'
