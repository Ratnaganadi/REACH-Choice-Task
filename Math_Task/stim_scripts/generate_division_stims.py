...
out_file= open('../math_stims_division.csv', 'w')
...
create_row(all_expressions=all_expressions, difficulty=difficulty, max_stims=16, label='Division by 1s up to 9')
difficulty+=1

# Division by 10s
all_expressions = create_product_expressions(num_set1=[10], num_set2=range(1,11), operators=['*'])
all_expressions = convert_to_division_expressions(all_expressions)
create_row(all_expressions=all_expressions, difficulty=difficulty, max_stims=16, label='Division by 10s up to 10')
difficulty+=1

product_sets = list(chunks(sorted_products, len(sorted_products)/3))
# Mixed Division Level 1
create_row(all_expressions = convert_to_division_expressions(product_sets[0]), difficulty=difficulty, max_stims=16, label='Mixed Division Level 1')
difficulty+=1

# Division by 1s
all_expressions = create_product_expressions(num_set1=[1], num_set2=range(10,31), operators=['*'])
all_expressions = convert_to_division_expressions(all_expressions)
create_row(all_expressions=all_expressions, difficulty=difficulty, max_stims=16, label='Division by 1s up to 30')
difficulty+=1

# Division by 10s
all_expressions = create_product_expressions(num_set1=[10], num_set2=range(10,31), operators=['*'])
all_expressions = convert_to_division_expressions(all_expressions)
create_row(all_expressions=all_expressions, difficulty=difficulty, max_stims=16, label='Division by 10s up to 30')
difficulty+=1

# Mixed Division Level 2
create_row(convert_to_division_expressions(product_sets[1]), difficulty=difficulty, max_stims=16, label='Mixed Division Level 2')
difficulty+=1

# Mixed Division Level 3
create_row(convert_to_division_expressions(product_sets[2]), difficulty=difficulty, max_stims=16, label='Mixed Division Level 3')
difficulty+=1


# Mixed 2-digit by 1-digit Division
...
all_expressions = convert_to_division_expressions(all_expressions)
create_row(all_expressions=all_expressions, difficulty=difficulty, max_stims=16, label='Mixed 2-digit by 1-digit Division')
difficulty+=1